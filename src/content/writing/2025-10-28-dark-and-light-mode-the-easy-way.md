...
Before we get to the final example, let's go over how this is done using a media query with [prefers-color-scheme](https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme).
